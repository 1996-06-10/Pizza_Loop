package com.example.pizzaloop.aadpters;
...
import com.example.pizzaloop.activities.PizzaDetails;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        viewHolder.view_container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("pizza_Id",mData.get(viewHolder.getAdapterPosition()).getPizza_Id());
                ...
                i.putExtra(" Pizza_image",mData.get(viewHolder.getAdapterPosition()).getImage_url());
